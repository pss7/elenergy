...
// 리스트에서 넘겨받은 reservation은 time이 Time으로 변환되어 들어옴(복제 진입용)
...
export default function ScheduledAddPage() {
  ...
  // 리스트 페이지에서 state로 넘겨주면 사용, 없으면 1번으로 기본 지정
  ...
  // 예약 바뀌면 선택/날짜 재설정 + 스크롤 초기화 준비(복제 진입 대응)
  useEffect(() => {
